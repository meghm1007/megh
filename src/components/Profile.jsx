...
// Try to import the profile image, but it may not exist yet
    ...
    <div className="flex flex-col items-center mb-12">
      ...
      <div className="w-full text-left">
        ...
        <p className="text-xl mb-4 text-center">
          i'm just a guy that loves{" "}
          <span className="highlight">creating things</span>
        </p>
        ...
        <p className="mb-4 mt-6">
          currently based in hamilton, ON🍁, i spend my days building SaaS
          products and AI Agents that make people's lives easier. <br />
          <br /> i believe in simple, thoughtful design and writing clean,
          efficient code. <br />
          <br />
